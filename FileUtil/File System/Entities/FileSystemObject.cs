...
namespace FileUtil.Foundation
{
    ...
    public abstract class FileSystemObject : IFileSystemObject, IFileInformation
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual FileSystemSecurity Permissions
        {
            get
            {
        ...
        /// </summary>        
        /// <returns></returns>
        public abstract Globals.ResultType Refresh();

        /// <summary>
        /// Delete this file
        /// </summary>
        /// <returns></returns>
        public abstract Globals.ResultType Delete();
        ...
        /// <returns></returns>
        public abstract Globals.ResultType Rename(string strNewName);
