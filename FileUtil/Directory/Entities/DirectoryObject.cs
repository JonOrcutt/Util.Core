...
namespace FileUtil.Directory
{
    ...
    public sealed class DirectoryObject : FileSystemObject, IFileSystemObject
    {
        ...
        private DirectorySecurity m_Permissions;
        /// <summary>
        /// Directory permissions
        /// </summary>
        public new DirectorySecurity Permissions
        {
            get
            {
        ...
        private Globals.ResultType LoadProperties()
        {
            try
            {
                ...
                this.m_Permissions = new DirectorySecurity(this);
        ...
        /// </summary>
        /// <returns></returns>
        public override Globals.ResultType Refresh()
        {
            // Delete File
        ...
        /// <returns></returns>
        public sealed override Globals.ResultType Rename(string strNewName)
        {
            try
            {
                // Get New File Path
        ...
        public Globals.ResultType Create(System.Security.AccessControl.FileSystemRights fileSystemRights, bool boolAllowEveryone = false)
        {
            try
            {
                ...
                // Validation
                if (directoryInfo == null || directoryInfo.Exists == false) { return Globals.ResultType.Failure; }
        ...
        /// <returns></returns>
        public sealed override Globals.ResultType Move(DirectoryObject destinationDirectoryObject)
        {
            try
            {
                // Validation
                if (destinationDirectoryObject.Exists == false) { return Globals.ResultType.Failure; }
        ...
        private Globals.ResultType Copy(DirectoryObject destinationDirectoryObject, DirectoryObject directoryToCopy)
        {
            try
            {
                ...
                if (directory.Exists == false)
                {
                    ...
                    // Validation
                    if (createResult == Globals.ResultType.Failure) { return Globals.ResultType.Failure; }
                }
                ...
                foreach (DirectoryObject childDirectory in directoryToCopy.SubDirectories)
                {
                    ...
                    // Validation
                    if (copyResult == Globals.ResultType.Failure) { return Globals.ResultType.Failure; }
                }
